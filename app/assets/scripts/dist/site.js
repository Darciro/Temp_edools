...
var init = function () {
	if (alreadyLoad === false) {
		...
		!function e(t, n, i) {
			...
			1: [function (e, t, n) {
				...
				var s = e("./pages.js");
				s.pesquisaCurso(), s.matriculaSemLogin(), s.aviseSemLogin(), s.matriculaCadastroCompletoCNPJouCPFVinculado(), s.loginsExterno(), s.confirmarMatricula(), s.confirmaPagamento(), s.filtroCurso(), s.filtroCursosConteudos(), s.linkChat();
			...
			2: [function (e, t, n) {
				var i = e("jquery"),
						...
						r = function (e) {
							var t, n, o, s, r, a = e.dsTag,
									l = e.dsName,
									u = e.dsDescription,
									d = i(".main").data("gamification_imgdir"),
									c = d + "symbol-defs.svg",
									h = {
						...
						d = function (e) {
							var t = i(".main").data("gamification_imgdir"),
			...
			3: [function (e, t, n) {
				...
				function o(e) {
					e.preventDefault();
					var t = r(".filter-form").serializeArray();
					t.push({
						name: "search_order",
						value: r('[name="search_order"]').val()
					});
					var n = r.ajax({
						method: "GET",
						url: "/?",
					...
					n.done(function (e) {
						history.pushState({}, "", "?" + r.param(t));
						var n = r("<div></div>");
						n.html(e);
						var i = n.find(".searchContent .btn-center").wrap("<div/>").parent().html(),
								o = n.find(".search-feedback").wrap("<div/>").parent().html();
						r(".searchContent .btn-center, .search-feedback").remove(), r(".searchContent .card-list").html("").after(i).before(o);
						var s = r(".masonry"),
								a = n.find(".itemsContent .card");
						s.isotope("remove", s.isotope("getItemElements")), s.isotope("insert", a), a.find("img").on("load", function () {
							s.isotope("layout")
						})
					}), n.fail(function (e) {
					})
				...
				t.exports = {
					pesquisaCurso: function () {
						function e() {
							r(".loadMoreResults").off("click").on("click", function (t) {
								t.preventDefault();
								var n = r(".loadMoreResults"),
										i = r.ajax({
											method: "GET",
											url: n.data("nextlink")
										});
								i.done(function (t) {
									var n = r("<div></div>");
									n.html(t), t = "", n.find(".linkContent").length > 0 && (t = n.find(".linkContent").html()), r(".linkContent").html(t);
									var i = r(".masonry"),
											o = n.find(".itemsContent .card");
					...
					filtroCurso: function () {
						r(".filter-menu-wp .filter-list-item, .filter-select").off("change").on("change", a)
					},
					matriculaSemLogin: function () {
						r(".btn-matricula-sem-login").on("click", function () {
							r(this).parent().parent().find(".login-register").slideDown()
						})
					},
					aviseSemLogin: function () {
						r(".btn-avise-sem-login").on("click", function () {
							r(this).parent().parent().find(".login-register").slideDown()
						})
					},
					matriculaCadastroCompletoCNPJouCPFVinculado: function () {
						function e(e) {
							var t = r.ajax({
								method: "GET",
								url: "/wp-content/themes/sebrae/do_verifica_cadastro_completo.php?verificaCNPJ=1",
								dataType: "json"
							});
							t.done(function (t) {
								e(t)
						...
						r(".btn-matricula-confirmacao").on("click", function () {
							var t = r(this);
							if (4 == t.data("formato")) {
								var n = r("input[type=radio][name=cidade]:checked").val();
								if ("" === n || "undefined" == typeof n) return s("Escolha a cidade que deseja fazer o curso."), !0;
								var i = t.data("redirect_to");
								i += "&cidade=" + n, e(function (e) {
									e.status === !0 ? window.location = i : window.location = e.redirect
								})
							} else e(function (e) {
								e.status === !0 ? window.location = t.data("redirect_to") : window.location = e.redirect + "?" + t.data("redirect_to").split("?")[1]
							})
						})
					},
					loginsExterno: function () {
						r(".btn-login-trilhas").on("click", function () {
							var e = r(this);
							r.ajax({
								method: "GET",
								url: e.data("do_register_historic")
							});
							var t = r.ajax({
								method: "GET",
								url: e.data("do_login")
							...
							t.done(function (t) {
								t.logado === !0 && (r.each(t.trilhas, function (e, t) {
									window.localStorage.setItem(e, t)
								}), window.location = e.data("redirect_to"))
							}), t.fail(function (e) {
							})
						}), r(".btn-login-consultoria").on("click", function () {
							var e = r(this);
							window.location = e.data("do_login")
						}), r(".btn-matricula-edools").on("click", function () {
							var e = r(this),
									t = r.ajax({
										method: "POST",
						...
						}), r(".btn-login-edools").on("click", function () {
							var e = (r(this), r.ajax({
								method: "GET",
								url: "/wp-content/themes/sebrae/do_login_edools.php"
							}));
							e.done(function (e) {
								e.status === !0 && (window.location = e.redirect_to)
							}), e.fail(function (e) {
							})
						}), r(".btn-avise-disponivel").on("click", function () {
							var e = r(this),
									t = r.ajax({
										method: "GET",
							...
							t.done(function (e) {
								r(".mensagem-presencial-text").html(e.message), r(".mensagem-presencial").slideDown(), setTimeout(function () {
									r(".mensagem-presencial").slideUp()
								}, 12e3)
							}), t.fail(function (e) {
							})
						}), r(".btn-presencialgratis-ri").on("click", function () {
							r(this);
							r(".interest-form-wrapper").is(":visible") || r(".interest-form-wrapper").slideDown(), r("#frmRegistrarInteresse").data("is-validated") !== !0 && (r("#frmRegistrarInteresse").data("is-validated", !0), r("#frmRegistrarInteresse").validate({
								...
								submitHandler: function (e) {
									var t = r(e).parent(),
											n = r.ajax({
												...
												dataType: "json",
												data: r("#frmRegistrarInteresse").serialize()
											});
									return n.done(function (n) {
										n.status === !0 && (r(e).remove(), t.append(n.message))
									}), n.fail(function (e) {
									}), !1
								}
							}))
						}), r(".btn-presencialgratis-ril").on("click", function () {
							var e = r(this),
									t = r(".interest-form-wrapper"),
									n = r.ajax({
										method: "POST",
										url: "/wp-content/themes/sebrae/do_registrar_interesse.php",
										dataType: "json",
										data: {
											cursoId: e.data("curso_id"),
											"interest-post-id": e.data("post_id")
										}
									});
							n.done(function (e) {
								t.find("form").remove(), t.find(".box-content").append(e.message), t.slideDown()
							}), n.fail(function (e) {
							})
						}), r(".btn-presencialgratis").on("click", function () {
							function e() {
								var e = r.ajax({
									method: "POST",
									...
									dataType: "json",
									data: {
										cursoId: t.data("curso_id"),
										postId: t.data("post_id"),
										cidade: n
									}
								});
								e.done(function (e) {
									e.status === !0 ? (r(".mensagem-presencial-text").html(e.message), r(".mensagem-presencial").slideDown()) : (r(".mensagem-presencial-text").html(e.message), r(".mensagem-presencial").slideDown()), setTimeout(function () {
										r(".mensagem-presencial").slideUp()
									}, 12e3)
								}), e.fail(function (e) {
								})
							...
							var t = r(this),
									n = r("form[name=frmCursoPresencial] input[name=cidade]:checked").val();
							if ("" === n || void 0 === n) return void s("Escolha a cidade que deseja fazer o curso.");
							var i = r.ajax({
								method: "GET",
								url: "/wp-content/themes/sebrae/do_verifica_cadastro_completo.php",
								dataType: "json"
							});
							i.done(function (t) {
								t.status === !0 ? e() : window.location = t.redirect
							}), i.fail(function (e) {
							})
						}), r(".btn-presencial").on("click", function () {
							var e = r(this),
									t = r.trim(e.data("redirect_to")),
									n = r("form[name=frmCursoPresencial] input[name=cidade]:checked").val();
							if ("" === n || void 0 === n) return void s("Escolha a cidade que deseja fazer o curso.");
							t += "&" + r.param({
								cidade: n
							...
							i.done(function (e) {
								e.status === !0 ? window.location = t : window.location = e.redirect
							}), i.fail(function (e) {
							})
						})
					},
					confirmarMatricula: function () {
						r(".confirmarMatricula").on("click", function (e) {
							var t = r(this),
									n = t.data("formato"),
									i = "",
									o = "";
							...
							s.done(function (e) {
								...
								} else r(".mensagem-matricula-text").html(e.messages.matricula), r(".mensagem-matricula").slideDown(), setTimeout(function () {
									r(".mensagem-matricula").slideUp()
								}, 12e3)
							}), s.fail(function (e) {
							})
						})
					...
					confirmaPagamento: function () {
						r("#frmPagamento").on("submit", function () {
							var e = r.ajax({
								method: "POST",
								url: "/wp-content/themes/sebrae/do_pagamento.php",
								dataType: "json",
								data: r("#frmPagamento").serialize()
							});
							e.done(function (e) {
								e.status === !0 ? window.location = r("#frmPagamento").attr("action") : (r(".mensagem-pagamento-text").html(e.messages.pagamento), r(".mensagem-pagamento").slideDown(), setTimeout(function () {
									r(".mensagem-pagamento").slideUp()
								}, 12e3))
							}), e.fail(function (e) {
							})
						})
					...
					linkChat: function () {
						var e = r.ajax({
							url: "/wp-content/themes/sebrae/do_chat_online.php",
							dataType: "text"
						});
						e.done(function (e) {
							r(".link-chat-online").prop("href", e)
						})
					},
					filtroCursosConteudos: function () {
						var e = r(".card-list-full .card"),
								t = r(".filter-menu-js .filter-list-item .form-checkbox").on("change.cursos", function () {
									var n = t.filter(":checked");
									n.length ? (e.hide().addClass("ignore"), n.each(function () {
										var t = r(this).val();
										e.filter(function () {
											return r(this).data("formato") == t
										}).show().removeClass("ignore")
									}), r("#search-input").trigger("keyup")) : e.show().removeClass("ignore")
								});
						r("#search-input").hideseek({
							list: ".card-list-full",
							ignore: ".ignore"
						}).on("_after_each", function () {
							e.filter(":visible").length ? r(".search-feedback-js").hide() : r(".search-feedback-js").show()
						}), r(".search-form-js .form-submit").on("click", function (e) {
							e.preventDefault(), r("#search-input").trigger("keyup")
						})
					}
				}
			}, {
			...
			4: [function (e, t, n) {
				...
				t.exports = {
					input: function () {
						$input = i(".form-text, .form-textarea"), $input.on("change blur keyup", function () {
							...
							var e = i(i(this).data("depends-field-wrapper")),
									t = !this.checked;
							...
							var t = 10 * parseFloat(this.value),
									n = 10 * parseInt(this.value),
									o = i("#star-rating-" + n);
						...
						i(".map").length && o.load(function (e) {
							...
							i.getJSON(location.protocol + "//" + location.host + "/wp-content/themes/sebrae/assets/data/sebraesc-markers.json", function (t) {
								i.each(t.markers, function (t, i) {
									var s = new e.maps.LatLng(i.lat, i.lon),
											r = '<div id="content"><div id="siteNotice"><h1 id="firstHeading" class="firstHeading">' + i.name + '</h1><div id="bodyContent"><p><small>' + i.address + '</small></p><p><small><a href="tel:' + i.phone + '">' + i.phone + "</a></small></p></div></div>",
											a = new e.maps.InfoWindow({
												content: r
											}),
											l = new e.maps.Marker({
												position: s,
					...
					slider: function () {
						var e = i(".slider");
						if (e.length) {
							var t = i(".price-range").data("start"),
									n = i(".price-range").data("end"),
									o = i("#price-start").val().split(" ")[1] || t,
									r = i("#price-end").val().split(" ")[1] || n,
									a = e[0];
							s.create(a, {
								start: [o, r],
								connect: !0,
								...
								t ? i(".price-end").val(e[t]) : i(".price-start").val(e[t])
							}), a.noUiSlider.on("change", function (e, t) {
								i(".price-end, .price-start").trigger("change")
							}), i(".price-start").on("change", function () {
								a.noUiSlider.set([this.value, null])
							}), i(".price-end").on("change", function () {
								a.noUiSlider.set([null, this.value])
							})
						}
					},
					filter: function () {
						function e() {
							var e = t.find(".filter-block :input").serialize(),
									n = e.replace(/[^&]+=\.?(?:&|$)/g, "");
							"" === n ? t.removeClass("form-not-empty") : t.addClass("form-not-empty")
						}

						var t = i(".filter-form"),
								n = t.find(".form-checkbox, .form-text");
				...
				jquery: 13,
				"jquery-chosen": 7,
				"jquery-mask-plugin": 11,
				"js-marker-clusterer": 14,
				mediaelement: 15,
				moment: 16,
				nouislider: 17,
				"pikaday/plugins/pikaday.jquery": 19
			}],
			5: [function (e, t, n) {
				var o = e("jquery");
				e("jquery-validation");
				var s = function (e) {
						...
						a = function (e) {
							var t = e.split("/"),
									n = new Date(t[1] + "/" + t[0] + "/" + t[2]),
									i = 2 == n.getDate().toString().length ? n.getDate() : "0" + n.getDate(),
									o = 2 == (n.getMonth() + 1).toString().length ? n.getMonth() + 1 : "0" + (n.getMonth() + 1),
									s = n.getFullYear();
						...
						l = function (e) {
							var t = new Date,
									n = e.split("/"),
									i = new Date(n[1] + "/" + n[0] + "/" + n[2]),
									o = t.getFullYear() - i.getFullYear(),
									s = t.getMonth() - i.getMonth();
							return (0 > s || 0 === s && t.getDate() < i.getDate()) && o--, o
						},
						u = function () {
							["data-fundacao", "razao-social", "nome-fantasia", "numero-funcionarios", "data-fundacao", "telefone-empresa", "porte", "setor", "cep-empresa", "forma-contato"].forEach(function (e) {
								var t = o("#register-" + e);
								t.length && (t.val(""), ("porte" === e || "setor" === e || "forma-contato" === e) && t.trigger("chosen:updated"), t.closest(".form-item").removeClass("form-item-has-value"), t.valid())
							})
						},
						d = function () {
				...
				t.exports = {
					config: function () {
						o.validator.addMethod("CEP", function (e, t) {
						...
						}, "CEP invÃ¡lido."), o.validator.addMethod("CPF", function (e, t) {
						...
						}, "CPF invÃ¡lido."), o.validator.addMethod("dateBR", function (e, t) {
							return 10 != e.length ? !1 : a(e) ? this.optional(t) || !0 : !1
						}, "Data invÃ¡lida."), o.validator.addMethod("olderThan14", function (e, t) {
							return l(e) < 14 ? !1 : this.optional(t) || !0
						}, "Data invÃ¡lida."), o.validator.addMethod("CNPJ", function (e, t) {
							return e.length < 18 ? (u(), !1) : this.optional(t) || !0
						}, "CNPJ invÃ¡lido."), o.validator.addMethod("customEmail", function (e, t) {
							return this.optional(t) || /^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i.test(e)
						}, "Email invÃ¡lido."), o.validator.addMethod("fullName", function (e, t) {
							return this.optional(t) || /^[Ã±Ã£ÃµÃ¡Ã©Ã­ÃºÃ³Ã¢ÃªÃ´Ã®Ã»Ã§a-z \'\.]+$/gi.test(e)
						}, "Nome invÃ¡lido."), o.validator.addMethod("username", function (e, t) {
							return this.optional(t) || /^[a-zA-Z\d-_\.\@]+$/.test(e)
						}, "Nome invÃ¡lido."), o.validator.addMethod("password", function (e, t) {
							return this.optional(t) || /^[^"\\]+$/.test(e)
						}, "Senha invÃ¡lida."), o.validator.addMethod("phoneBR", function (e, t) {
							return e = e.replace("(", ""), e = e.replace(")", ""), e = e.replace("-", ""), e = e.replace("_", ""), e = e.replace(" ", ""), this.optional(t) || /[0-9]{10}/.test(e) || /[0-9]{11}/.test(e)
						}, "Telefone invÃ¡lido."), o.validator.addMethod("dateFundacao", function (e, t) {
							return this.optional(t) || /^((0[1-9])|(1[0-2]))\/(?:(?:19|20)[0-9]{2})$/.test(e)
						}, "Data de fundaÃ§Ã£o invÃ¡lida, informe o MM/YYYY."), o.extend(o.validator.messages, {
							required: "Este campo Ã© obrigatÃ³rio.",
							remote: "Por favor, corrija este campo.",
							email: "Por favor, forneÃ§a um endereÃ§o de e-mail vÃ¡lido.",
							url: "Por favor, forneÃ§a uma URL vÃ¡lida.",
							dateBR: "Por favor, forneÃ§a uma data vÃ¡lida.",
							olderThan14: "Idade mÃ­nima de 14 anos.",
							CEP: "Por favor, forneÃ§a um CEP vÃ¡lido.",
							CPF: "Por favor, forneÃ§a um CPF vÃ¡lido.",
							phoneBR: "Por favor, forneÃ§a um telefone vÃ¡lido.",
							maxlength: o.validator.format("Por favor, forneÃ§a nÃ£o mais que {0} caracteres."),
							minlength: o.validator.format("Por favor, forneÃ§a ao menos {0} caracteres."),
							digits: "Por favor, forneÃ§a um nÃºmero inteiro.",
							fullName: "Por favor, forneÃ§a um nome vÃ¡lido. Apenas letras, apÃ³strofo e ponto.",
							username: 'Por favor, forneÃ§a um usuÃ¡rio vÃ¡lido. Apenas letras, nÃºmeros, "-","_","@"',
							password: 'NÃ£o sÃ£o permitido os caracteres (\\ e ").'
							...
							unhighlight: function (e, t, n) {
								...
								var i = o(e).closest(".form-item");
								if (i.find(".form-success-icon").length) i.find(".form-success-icon").show();
								else {
									var s = o("<label/>", {
										"for": o(e).prop("id"),
					...
					updatePassword: function () {
						var e = o(".form-recover-password"),
								t = e.find("form"),
								n = t.find(".form-submit-wrapper .btn"),
								i = o(".form-recover-password form").validate({
									invalidHandler: function (e, t) {
					...
					recoverPassword: function () {
						o(".header-password form, .section-password form").each(function () {
							var e = o(this).find(".form-submit-wrapper .btn"),
									t = "." + o(this).parent().attr("class").split(" ")[0],
									n = o(this).validate({
										...
										submitHandler: function (i) {
											...
											return l.done(function (s) {
												r(e), e.prop("disabled", !1), s.status ? (o(t + "-email").text(s.email), o(t).hide(), o(t + "-confirm").show(), i.reset()) : (n.showErrors(s.messages), n.focusInvalid())
											}), !1
										}
									})
						})
					...
					login: function () {
						o(".header-login form, .section-login form").each(function () {
							var e = o(this).validate({
								invalidHandler: function (e, t) {
								},
								submitHandler: function (t) {
									...
									return i.done(function (t) {
										r("#login-user"), t.status ? window.location = t.redirect_to ? t.redirect_to : window.location.href.replace("login/", "") : (e.showErrors(t.messages), e.focusInvalid())
									}), i.fail(function (t) {
					...
					register: function () {
						var e = o(".form-register"),
								t = e.find("form"),
								n = t.find(".form-submit-wrapper .btn"),
								i = t.find(".form-submit-wrapper .status"),
								a = "",
								l = t.validate({
									onfocusout: function (e) {
									...
									submitHandler: function (u) {
										s(n), n.prop("disabled", !0), a = i.text(), e.hasClass("form-register-simple") ? i.text("Finalizando seu cadastro! :)") : e.hasClass("form-register-all-fields") && i.text("Salvando alteraÃ§Ãµes! :)");
										var d = o.ajax({
											method: "POST",
											url: t.attr("action"),
										...
										d.always(function () {
											...
											if (t.status) {
												if (e.hasClass("form-register-simple") ? i.text("Cadastro Finalizado! :)") : e.hasClass("form-register-all-fields") && i.text("AlteraÃ§Ãµes salvas! :)"), n.hide(), "/cadastro-erro/" == t.url || "/meu-espaco-erro/" == t.url) return void o(".main").html(t.messageHtml);
								...
								c = function (e) {
									t.find(".step-" + e).addClass("step-open"), 1 === e ? o(".step-open").removeClass("step-open") : 2 === e ? t.find(".status").text("Agora falta pouco! :)") : 3 === e && (t.addClass("last-step"), t.find(".status").text("Quase lÃ¡ :)"))
								};
						o(".btn-edit-cpf").on("click", function (e) {
							e.preventDefault();
							var n = o(this),
									i = n.closest(".form-item"),
									s = i.find(".form-text");
							s.prop("readonly", !1).val(""), n.hide(), i.find(".btn-check-cpf").show(), t.find(".form-item").removeClass("form-item-valid").removeClass("form-item-has-value"), t.find(".form-success-icon").remove(), t.find(".form-submit-wrapper").hide(), t[0].reset(), c(1)
						...
						o(".step-3").removeClass(function (e, t) {
							...
							e.preventDefault();
							var t = o(this).closest(".form-item").find(".form-text");
							t.valid(), t.focus()
						});
						var p = function (e) {
							return {
								onfocusout: function (e) {
									return "" === o(e).val() && "situacao-3" != o(".radio-situacao:checked").val() ? (u(), d(), !0) : void 0
								},
								remote: {
									...
									dataFilter: function (t) {
										r(e);
										var n = window.location.pathname.replace(/\/$/, "").split("/").pop(),
												i = o("#row-razao-social"),
												s = o("#register-razao-social"),
												a = o("#register-data-fundacao"),
												l = o("#register-nome-fantasia"),
												c = o("#register-porte"),
												h = o("#register-setor"),
												p = o("#register-telefone-empresa"),
												f = o("#register-cnpj"),
												m = o("#register-numero-funcionarios"),
												g = o("#register-forma-contato"),
												v = o.parseJSON(t);
										return v.status ? (v.data ? (v.data.cnpj && f && f.valid(), "meu-espaco" == n && ("" == s.val() && s && (s.val(v.data.razao_social).closest(".form-item").addClass("form-item-has-value"), s.valid()), v.data.data_fundacao && a && (a.val(v.data.data_fundacao).closest(".form-item").addClass("form-item-has-value"), a.valid()), v.data.funcionarios && m && (m.val(v.data.funcionarios).closest(".form-item").addClass("form-item-has-value"), m.valid()), v.data.nome_fantasia && l && (l.val(v.data.nome_fantasia).closest(".form-item").addClass("form-item-has-value"), l.valid()), v.data.telefone && p && (p.val(v.data.telefone).closest(".form-item").addClass("form-item-has-value"), p.valid()), v.data.porte && c && (c.val(v.data.porte).closest(".form-item").addClass("form-item-has-value"), c.trigger("chosen:updated"), c.valid()), v.data.setor && h && (h.val(v.data.setor).closest(".form-item").addClass("form-item-has-value"), h.trigger("chosen:updated"), h.valid()), v.data.contato.forma && g && (g.val(v.data.contato.forma).closest(".form-item").addClass("form-item-has-value"), g.trigger("chosen:updated"), g.valid())), "cadastro" == n && ("" == v.data.razao_social ? i.removeClass("form-item-hide") : i.addClass("form-item-hide"), s.val("")), o.each(v.data.endereco, function (e, t) {
											"cep" === e && (e = "cep-empresa");
											var n = o("#register-" + e);
											n.length && (n.val(t).closest(".form-item").addClass("form-item-has-value"), "uf" === e.toLowerCase() && n.val(t).trigger("chosen:updated"), n.valid())
										})) : "cadastro" == n && (s.val(""), i.removeClass("form-item-hide")), !0) : (u(), d(), '"' + v.message + '"')
									}
								}
							}
						};
						o(".cnpj").each(function () {
							var e = o(this);
							e.closest(".form-item").hasClass("form-item-has-value") ? e.on("keyup.rule", function () {
								o(this).rules("add", p(e)), o(this).off("keyup.rule")
							}) : e.rules("add", p(e))
						});
						var f = function (e) {
							return {
								remote: {
									...
									dataFilter: function (n) {
										return r(e), n = o.parseJSON(n), n.status ? (c(2), "register-cpf" === e.prop("id") && (e.prop("readonly", !0), void 0 !== n.data && ($registerLogin = o("#register-usuario"), void 0 !== n.data.login && "" !== n.data.login ? ($registerLogin.prop("readonly", !0), $registerLogin.val(n.data.login).closest(".form-item").addClass("form-item-has-value")) : ($registerLogin.prop("readonly", !1), $registerLogin.val("").closest(".form-item").removeClass("form-item-has-value")), "" != n.data.nome && (o("#register-nome").val(n.data.nome).closest(".form-item").addClass("form-item-has-value"), o("#register-nome").valid()), "" != n.data.nascimento && (o("#register-data-nascimento").val(n.data.nascimento).closest(".form-item").addClass("form-item-has-value"), o("#register-data-nascimento").valid()), "" != n.data.email && (o("#register-email").val(n.data.email).closest(".form-item").addClass("form-item-has-value"), o("#register-email").valid()), "" != n.data.telefone_celular && (o("#register-celular").val(n.data.telefone_celular).closest(".form-item").addClass("form-item-has-value"), o("#register-celular").valid()), "" != n.data.sexo && (o("#register-genero-" + n.data.sexo.toLowerCase()).prop("checked", !0), o("#register-genero-" + n.data.sexo.toLowerCase()).valid())), e.closest(".form-item").find(".btn-check-cpf").hide(), t.find(".form-submit-wrapper").show(), o("#register-nome").focus()), !0) : (o("#register-usuario").focus(), '"' + n.message + '"')
									}
								}
							}
						};
						o(".cpf").each(function () {
							var e = o(this);
							e.closest(".form-item").hasClass("form-item-has-value") ? e.on("keyup.rule", function () {
								o(this).rules("add", f(e)), o(this).off("keyup.rule")
							}) : e.rules("add", f(e))
						});
						var m = function (e) {
							return {
								...
								remote: {
									...
									cache: !1,
									beforeSend: function (t, n) {
										n.data = n.data.replace("cep-residencial", "cep"), n.data = n.data.replace("cep-empresa", "cep"), s(e)
									},
									dataFilter: function (t) {
						...
						o(".cep").each(function () {
							var e = o(this);
							e.closest(".form-item").hasClass("form-item-has-value") ? e.on("keyup.rule", function () {
								o(this).rules("add", m(e)), o(this).off("keyup.rule")
							}) : e.rules("add", m(e))
						...
						var e = o(".newsletter form").validate({
							...
							submitHandler: function (t) {
								...
								var n = o.ajax({
									method: "POST",
									url: o(t).prop("action"),
									data: o(t).serialize() + "&_wpcf7=18&_wpcf7_version=4.3.1&_wpcf7_locale=pt_BR&_wpcf7_unit_tag=wpcf7-f18-o1&_wpnonce=3cc99d2e46&_wpcf7_is_ajax_call=1",
									dataType: "json"
								});
								n.done(function (t) {
									if( typeof(t) === 'undefined' ){
										console.log('Response undefined: ', t);
									}else{
										r("#newsletter-email"), t.mailSent ? (o(e.currentForm).removeClass("not-sent").addClass("sent-ok"), o(".wpcf7-response-output").addClass("form-response").html(t.message)) : o(e.currentForm).removeClass("sent-ok").addClass("not-sent")
									}
								});
							}
						})
					...
					contact: function () {
						var e = o(".contact form").validate({
							...
							submitHandler: function (t) {
								...
								n.done(function (t) {
									r("#contact-email"), t.mailSent ? (o(e.currentForm).removeClass("not-sent").addClass("sent-ok"), o(".wpcf7-response-output").addClass("form-response").html(t.message)) : o(e.currentForm).removeClass("sent-ok").addClass("not-sent")
								})
							}
						})
					},
					...
					recommend: function () {
						o(".recommend form").each(function () {
							var t = o(this);
							t.validate({
								invalidHandler: function (e, t) {
								},
								submitHandler: function (n) {
									...
									i.done(function (n) {
										n.status && (t.find(".form-item, .form-submit-wrapper").hide(), t.append('<div class="response-msg"><p>RecomendaÃ§Ã£o Enviada! </p><a href="#" class="btn btn-type-1 new-recommend">Enviar outro comentÃ¡rio!</a></div>'), e(t[0]))
									})
								}
							})
						});
						var e = function (e) {
							o(".recommend .new-recommend").on("click", function (t) {
								...
								var n = o(e);
								n.find(".response-msg").remove(), n.find(".form-success-icon").remove(), n.find(".form-item, .form-submit-wrapper").show()
							})
						}
					},
					rating: function () {
					...
					comment: function () {
						...
						e.validate({
							...
							submitHandler: function (n) {
								...
								i.done(function (n) {
									n.status && (e.find(".form-item, .form-submit-wrapper").hide(), e.append('<div class="response-msg"><p>Todos os comentÃ¡rios passam por avaliaÃ§Ã£o para evitar spam. Em no mÃ¡ximo 24h seu comentÃ¡rio serÃ¡ avaliado.</p><a href="#" class="btn btn-type-1 new-comment">Enviar outro comentÃ¡rio!</a></div>'), t())
								})
							}
						});
						var t = function () {
					...
					downloadSaveReportHistoric: function () {
						...
						function (e) {
							var t = e.validator.methods.required;
							e.validator.methods.required = function () {
								return arguments.length > 0 && (arguments[0] = e.trim(arguments[0])), t.apply(this, arguments)
							}
						}(jQuery)
			}, {
				jquery: 13,
				"jquery-validation": 12
			}],
			6: [function (e, t, n) {
				!function (e) {
					var t = {
					...
					e.fn.bxSlider = function (n) {
						...
						if (!e(s).data("bxSlider")) {
							var l = function () {
										...
										}, o.carousel = o.settings.minSlides > 1 || o.settings.maxSlides > 1 ? !0 : !1, o.carousel && (o.settings.preloadImages = "all"), o.minThreshold = o.settings.minSlides * o.settings.slideWidth + (o.settings.minSlides - 1) * o.settings.slideMargin, o.maxThreshold = o.settings.maxSlides * o.settings.slideWidth + (o.settings.maxSlides - 1) * o.settings.slideMargin, o.working = !1, o.controls = {}, o.interval = null, o.animProp = "vertical" === o.settings.mode ? "top" : "left", o.usingCSS = o.settings.useCSS && "fade" !== o.settings.mode && function () {
									...
									g = function () {
										...
										if (o.settings.moveSlides > 0)
											if (o.settings.infiniteLoop) e = Math.ceil(o.children.length / v());
												...
												for (; t < o.children.length;) ++e, t = n + m(), n += o.settings.moveSlides <= m() ? o.settings.moveSlides : m();
									...
									w = function () {
										o.settings.pagerCustom ? o.pagerEl = e(o.settings.pagerCustom) : (o.pagerEl = e('<div class="bx-pager" />'), o.settings.pagerSelector ? e(o.settings.pagerSelector).html(o.pagerEl) : o.controls.el.addClass("bx-has-pager").append(o.pagerEl), b()), o.pagerEl.on("click touchend", "a", j)
									},
									x = function () {
									...
									F = function (e) {
										var t, n, i, r = e ? e : o.settings.speed,
												a = {
													left: 0,
													top: 0
												},
										...
										"next" === o.settings.autoDirection ? a = s.find(".bx-clone").first().position() : l = o.children.first().position(), t = "horizontal" === o.settings.mode ? -a.left : -a.top, n = "horizontal" === o.settings.mode ? -l.left : -l.top, i = {
											resetValue: n
										}, _(t, "ticker", r, i)
									},
									z = function (t) {
									...
									q = function (e) {
										var t = e.originalEvent,
												...
												r = 0,
												a = 0;
										3 * i > s && o.settings.preventDefaultSwipeX ? e.preventDefault() : 3 * s > i && o.settings.preventDefaultSwipeY && e.preventDefault(),
										"fade" !== o.settings.mode && o.settings.oneToOneTouch && ("horizontal" === o.settings.mode ? (a = n[0].pageX - o.touch.start.x, r = o.touch.originalPos.left + a) : (a = n[0].pageY - o.touch.start.y, r = o.touch.originalPos.top + a), _(r, "reset", 0))
									},
									Y = function (e) {
							...
							return s.goToSlide = function (t, n) {
								...
								if (o.oldIndex = o.active.index, o.active.index = V(t), !o.working && o.active.index !== o.oldIndex) {
									...
									"next" === n ? o.settings.onSlideNext.call(s, o.children.eq(o.active.index), o.oldIndex, o.active.index) || (u = !1) : "prev" === n && (o.settings.onSlidePrev.call(s, o.children.eq(o.active.index), o.oldIndex, o.active.index) || (u = !1)), o.active.last = o.active.index >= g() - 1, (o.settings.pager || o.settings.pagerCustom) && D(o.active.index), o.settings.controls && A(), "fade" === o.settings.mode ? (o.settings.adaptiveHeight && o.viewport.height() !== h() && o.viewport.animate({
										height: h()
										...
										height: h()
									}, o.settings.adaptiveHeightSpeed), !o.settings.infiniteLoop && o.carousel && o.active.last ? "horizontal" === o.settings.mode ? (p = o.children.eq(o.children.length - 1), c = p.position(), d = o.viewport.width() - p.outerWidth()) : (i = o.children.length - o.settings.minSlides, c = o.children.eq(i).position()) : o.carousel && o.active.last && "prev" === n ? (r = 1 === o.settings.moveSlides ? o.settings.maxSlides - v() : (g() - 1) * v() - (o.children.length - o.settings.maxSlides), p = s.children(".bx-clone").eq(r), c = p.position()) : "next" === n && 0 === o.active.index ? (c = s.find("> .bx-clone").eq(o.settings.maxSlides).position(), o.active.last = !1) : t >= 0 && (l = t * parseInt(v()), c = o.children.eq(l).position()), "undefined" != typeof c ? (a = "horizontal" === o.settings.mode ? -(c.left - d) : -c.top, _(a, "slide", o.settings.speed)) : o.working = !1), o.settings.ariaHidden && U(o.active.index * v())
								}
								...
								o.children.add(s.find(".bx-clone")).outerWidth(f()), o.viewport.css("height", h()), o.settings.ticker || y(), o.active.last && (o.active.index = g() - 1), o.active.index >= g() && (o.active.last = !0), o.settings.pager && !o.settings.pagerCustom && (b(), D(o.active.index)), o.settings.ariaHidden && U(o.active.index * v())
			...
			7: [function (e, t, n) {
				(function (n) {
					e("/Users/leonardo.koslowski/Sites/portal-atendimento-2015/src/wp-content/themes/sebrae/node_modules/jquery/dist/jquery.js");
					(function (e, t, n) {
						(function () {
							var e, t, n, i, o, s = {}.hasOwnProperty,
									r = function (e, t) {
										function n() {
											this.constructor = e
										}
				...
				"/Users/leonardo.koslowski/Sites/portal-atendimento-2015/src/wp-content/themes/sebrae/node_modules/jquery/dist/jquery.js": 13
			}],
			8: [function (e, t, n) {
				(function (e) {
					(function (e, t, n, i, o) {
				...
				!function (e, t, n) {
					...
					e.fn.hideseek = function (t) {
						...
						return this.each(function () {
							var n = e(this);
							n.opts = [], e.map(["list", "nodata", "attribute", "highlight", "ignore", "headers", "navigation", "ignore_accents", "hidden_mode"], function (e, i) {
								n.opts[e] = n.data(e) || t[e]
							}), n.opts.headers && (n.opts.ignore += n.opts.ignore ? ", " + n.opts.headers : n.opts.headers);
							var i = e(n.opts.list);
							n.opts.navigation && n.attr("autocomplete", "off"), n.opts.hidden_mode && i.children().hide(), n.keyup(function (t) {
								function o(e) {
								...
								if (38 != t.keyCode && 40 != t.keyCode && 13 != t.keyCode) {
									...
									i.children(n.opts.ignore.trim() ? ":not(" + n.opts.ignore + ")" : "").removeClass("selected").each(function () {
										var t = "text" != n.opts.attribute ? e(this).attr(n.opts.attribute).toLowerCase() : e(this).text().toLowerCase(),
												i = -1 == t.removeAccents(n.opts.ignore_accents).indexOf(a) || a === (n.opts.hidden_mode ? "" : !1);
										i ? (e(this).hide(), n.trigger("_after_each")) : (n.opts.highlight ? e(this).removeHighlight().highlight(a).show() : e(this).show(), n.trigger("_after_each"))
									}), n.opts.nodata && (i.find(".no-results").remove(), i.children(':not([style*="display: none"])').length || i.children().first().clone().removeHighlight().addClass("no-results").show().prependTo(n.opts.list).text(n.opts.nodata)), n.opts.headers && e(n.opts.headers, i).each(function () {
										e(this).nextUntil(n.opts.headers).not('[style*="display: none"],' + n.opts.ignore).length ? e(this).show() : e(this).hide()
									}), n.trigger("_after")
								}
								n.opts.navigation && (38 == t.keyCode ? o(i).length ? (s(i).addClass("selected"), o(i).last().removeClass("selected")) : i.children(":visible").last().addClass("selected") : 40 == t.keyCode ? o(i).length ? (r(i).addClass("selected"), o(i).first().removeClass("selected")) : i.children(":visible").first().addClass("selected") : 13 == t.keyCode && (o(i).find("a").length ? document.location = o(i).find("a").attr("href") : n.val(o(i).text())))
							})
						})
					...
					function t(e, n) {
						var i = 0;
						if (3 == e.nodeType) {
							var o = e.data.removeAccents(!0).toUpperCase().indexOf(n);
							if (o >= 0) {
								var s = document.createElement("mark");
								s.className = "highlight";
								var r = e.splitText(o);
								r.splitText(n.length);
								var a = r.cloneNode(!0);
								s.appendChild(a), r.parentNode.replaceChild(s, r), i = 1
							}
						} else if (1 == e.nodeType && e.childNodes && !/(script|style)/i.test(e.tagName))
							for (var l = 0; l < e.childNodes.length; ++l) l += t(e.childNodes[l], n);
						return i
					}
					...
					return e ? this.replace(/[Ã¡Ã Ã£Ã¢Ã¤]/gi, "a").replace(/[Ã©Ã¨Â¨Ãª]/gi, "e").replace(/[Ã­Ã¬Ã¯Ã®]/gi, "i").replace(/[Ã³Ã²Ã¶Ã´Ãµ]/gi, "o").replace(/[ÃºÃ¹Ã¼Ã»]/gi, "u").replace(/[Ã§]/gi, "c").replace(/[Ã±]/gi, "n") : this
				}
			}, {}],
			10: [function (e, t, n) {
				(function (n) {
						...
						!function (e) {
										...
										if ("string" == typeof i) {
											for (var s = r.call(arguments, 1), a = 0, l = this.length; l > a; a++) {
												var u = this[a],
														d = e.data(u, t);
												if (d)
													if (e.isFunction(d[i]) && "_" !== i.charAt(0)) {
														var c = d[i].apply(d, s);
							...
							"function" == typeof o && o.amd ? o("jquery-bridget/jquery.bridget", ["jquery"], s) : s("object" == typeof t ? i("jquery") : e.jQuery)
								...
								function (n) {
									function i(e) {
										if (e) {
											...
											for (var t, n = 0, i = s.length; i > n; n++)
												if (t = s[n] + e, "string" == typeof r[t]) return t
										}
									}
									...
									function u(e) {
										...
										function i(e) {
											if (t(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
												...
												var v = i.paddingLeft + i.paddingRight,
								...
								function (n) {
									...
									function r(e, t) {
										s(e);
										for (var n = e.parentNode.querySelectorAll(t), i = 0, o = n.length; o > i; i++)
											if (n[i] === e) return !0;
										return !1
									}
							...
							behaviour: function (t) {
								...
								if (-1 === e.inArray(n, s.byPassKeys)) {
									var i = a.getCaret(),
											...
											u = a.getMasked(),
											d = u.length,
											c = a.getMCharsBeforeCount(d - 1) - a.getMCharsBeforeCount(r - 1);
								...
								methods: {
									...
									remote: function (t, n, i) {
										...
										return this.settings.messages[n.name] || (this.settings.messages[n.name] = {}), r.originalMessage = this.settings.messages[n.name].remote, this.settings.messages[n.name].remote = r.message, i = "string" == typeof i && {
											url: i
										} || i, r.old === t ? r.valid : (r.old = t, o = this, this.startRequest(n), s = {}, s[n.name] = t, e.ajax(e.extend(!0, {
											mode: "abort",
					...
					(function (e, t, n, i, o) {
						!function (t, n) {
							...
							function p(e, t, n, i, o) {
								for (var s, r, a, l, u, d, p = t.createDocumentFragment(), f = [], m = 0, g = e.length; g > m; m++)
									if (s = e[m], s || 0 === s)
								...
								for (p.textContent = "", m = 0; s = f[m++];)
									if (i && re.inArray(s, i) > -1) o && o.push(s);
									else if (u = re.contains(s.ownerDocument, s), r = c(p.appendChild(s), "script"), u && h(r), n)
							...
							function w(e, t) {
								...
								if (1 === t.nodeType) {
									if (Te.hasData(e) && (s = Te.access(e), r = Te.set(t, s), u = s.events)) {
										...
										for (o in u)
											for (n = 0, i = u[o].length; i > n; n++) re.event.add(t, o, u[o][n])
									}
							...
							function k(e, t, n, i) {
								...
								if (h && (o = p(t, e[0].ownerDocument, !1, e, i), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
									...
									if (a)
										for (u = r[r.length - 1].ownerDocument, re.map(r, b), d = 0; a > d; d++) l = r[d], Fe.test(l.type || "") && !Te.access(l, "globalEval") && re.contains(u, l) && (l.src ? re._evalUrl && re._evalUrl(l.src) : re.globalEval(l.textContent.replace(Ve, "")))
								}
								return e
							}
							...
							function P(t, n, i) {
								var o = !0,
										...
										r = Qe(t),
										a = "border-box" === re.css(t, "boxSizing", !1, r);
							...
							function z(e, t, n) {
								for (var i, o = (H.tweeners[t] || []).concat(H.tweeners["*"]), s = 0, r = o.length; r > s; s++)
									if (i = o[s].call(n, t, e)) return i
							}

							function O(e, t, n) {
								var i, o, s, r, a, l, u, d, c = this,
										h = {},
										p = e.style,
										f = e.nodeType && Ae(e),
										m = Te.get(e, "fxshow");
								...
								if (re.isEmptyObject(h)) "inline" === ("none" === u ? T(e.nodeName) : u) && (p.display = u);
								else {
							...
							function R(e, t) {
								var n, i, o, s, r;
								for (n in e)
									if (i = re.camelCase(n), o = t[i], s = e[n], re.isArray(s) && (o = s[1], s = e[n] = s[0]), n !== i && (e[i] = s, delete e[n]), r = re.cssHooks[i], r && "expand" in r) {
							...
							function H(e, t, n) {
								...
								for (R(d, u.opts.specialEasing); r > s; s++)
									if (i = H.prefilters[s].call(u, e, d, u.opts)) return re.isFunction(i.stop) && (re._queueHooks(u.elem, u.opts.queue).stop = re.proxy(i.stop, i)), i;
							...
							function $(e, t, n, i) {
								...
								if (re.isArray(t)) re.each(t, function (t, o) {
									n || Dt.test(e) ? i(e, o) : $(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, i)
								});
							...
							re.fn = re.prototype = {
								...
								var e, t, n, i, o, s, r = arguments[0] || {},
										...
										l = arguments.length,
										u = !1;
								for ("boolean" == typeof r && (u = r, r = arguments[a] || {}, a++), "object" == typeof r || re.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++)
									if (null != (e = arguments[a]))
										for (t in e) n = r[t], i = e[t], r !== i && (u && i && (re.isPlainObject(i) || (o = re.isArray(i))) ? (o ? (o = !1, s = n && re.isArray(n) ? n : []) : s = n && re.isPlainObject(n) ? n : {}, r[t] = re.extend(u, s, i)) : void 0 !== i && (r[t] = i));
								return r
							}, re.extend({
							...
							var ce = function (e) {
								function t(e, t, n, i) {
									var o, s, r, a, l, u, c, p, f = t && t.ownerDocument,
											m = t ? t.nodeType : 9;
								...
								function v(e, t, n, o, s, r) {
									return o && !o[R] && (o = v(o)), s && !s[R] && (s = v(s, r)), i(function (i, r, a, l) {
										var u, d, c, h = [],
												...
												_ = n ? s || (i ? e : f || o) ? [] : r : y;
										if (n && n(y, _, a, l), o)
											for (u = g(_, p), o(u, [], a, l), d = u.length; d--;)(c = u[d]) && (_[p[d]] = !(y[p[d]] = c));
										if (i) {
											if (s || e) {
												if (s) {
									...
									var o = n.length > 0,
											...
											r = function (i, r, a, l, u) {
												...
												for (u && (E = r === P || r || u); f !== w && null != (d = _[f]); f++) {
													if (s && d) {
														for (c = 0, r || d.ownerDocument === P || (L(d), a = !N); h = e[c++];)
															if (h(d, r || P, a)) {
																l.push(d);
																break
															}
								...
								var b, w, x, k, S, C, T, M, E, j, D, L, P, A, N, I, F, z, O, R = "sizzle" + 1 * new Date,
										H = e.document,
										W = 0,
										q = 0,
										Y = n(),
								...
								w = t.support = {}, S = t.isXML = function (e) {
									...
									return i !== P && 9 === i.nodeType && i.documentElement ? (P = i, A = P.documentElement, N = !S(P), (n = P.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)), w.attributes = o(function (e) {
										...
										return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === P || e.ownerDocument === H && O(H, e) ? -1 : t === P || t.ownerDocument === H && O(H, t) ? 1 : j ? ee(j, e) - ee(j, t) : 0 : 4 & n ? -1 : 1)
									} : function (e, t) {
										if (e === t) return D = !0, 0;
										var n, i = 0,
												o = e.parentNode,
												...
												a = [e],
												l = [t];
										if (!o || !s) return e === P ? -1 : t === P ? 1 : o ? -1 : s ? 1 : j ? ee(j, e) - ee(j, t) : 0;
										if (o === s) return r(e, t);
									...
									if ((e.ownerDocument || e) !== P && L(e), n = n.replace(de, "='$1']"), w.matchesSelector && N && !U[n + " "] && (!F || !F.test(n)) && (!I || !I.test(n))) try {
										var i = z.call(e, n);
									...
									var t, n = [],
											i = 0,
											o = 0;
									if (D = !w.detectDuplicates, j = !w.sortStable && e.slice(0), e.sort(V), D) {
									...
									filter: {
										...
										CHILD: function (e, t, n, i, o) {
											...
											return 1 === i && 0 === o ? function (e) {
												...
												var u, d, c, h, p, f, m = s !== r ? "nextSibling" : "previousSibling",
														g = t.parentNode,
												...
												if (g) {
													...
													if (f = [r ? g.firstChild : g.lastChild], r && y) {
														for (h = g, c = h[R] || (h[R] = {}), d = c[h.uniqueID] || (c[h.uniqueID] = {}), u = d[e] || [], p = u[0] === W && u[1], _ = p && u[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (_ = p = 0) || f.pop();)
															if (1 === h.nodeType && ++_ && h === t) {
																d[e] = [W, p, _];
																break
															}
													} else if (y && (h = t, c = h[R] || (h[R] = {}), d = c[h.uniqueID] || (c[h.uniqueID] = {}), u = d[e] || [], p = u[0] === W && u[1], _ = p), _ === !1)
														for (;
																(h = ++p && h && h[m] || (_ = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++_ || (y && (c = h[R] || (h[R] = {}), d = c[h.uniqueID] || (c[h.uniqueID] = {}), d[e] = [W, _]), h !== t)););
								...
								return c.prototype = x.filters = x.pseudos, x.setFilters = new c, C = t.tokenize = function (e, n) {
									...
									if (n = n || [], 1 === c.length) {
										...
										for (o = pe.needsContext.test(e) ? 0 : s.length; o-- && (r = s[o], !x.relative[a = r.type]);)
											if ((l = x.find[a]) && (i = l(r.matches[0].replace(be, we), ye.test(s[0].type) && d(t.parentNode) || t))) {
												if (s.splice(o, 1), e = i.length && h(s), !e) return J.apply(n, i), n;
												break
											}
									}
									return (u || T(e, c))(i, t, !N, n, !t || ye.test(e) && d(t.parentNode) || t), n
								}, w.sortStable = R.split("").sort(V).join("") === R, w.detectDuplicates = !!D, L(), w.sortDetached = o(function (e) {
							...
							var ve, ye = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
									_e = re.fn.init = function (e, t, n) {
										...
										if (n = n || ve, "string" == typeof e) {
											...
											if (i[1]) {
												if (t = t instanceof re ? t[0] : t, re.merge(this, re.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : X, !0)), me.test(i[1]) && re.isPlainObject(t))
							...
							re.fn.extend({
								...
								closest: function (e, t) {
									for (var n, i = 0, o = this.length, s = [], r = fe.test(e) || "string" != typeof e ? re(e, t || this.context) : 0; o > i; i++)
							...
							re.Callbacks = function (e) {
								...
								when: function (e) {
									var t, n, i, o = 0,
											s = Q.call(arguments),
											r = s.length,
											a = 1 !== r || e && re.isFunction(e.promise) ? r : 0,
											l = 1 === a ? e : re.Deferred(),
											u = function (e, n, i) {
												return function (o) {
									...
									if (r > 1)
										for (t = new Array(r), n = new Array(r), i = new Array(r); r > o; o++) s[o] && re.isFunction(s[o].promise) ? s[o].promise().progress(u(o, n, t)).done(u(o, i, s)).fail(l.reject) : --a;
							...
							re.extend({
								...
								data: function (e, t) {
									...
									return "object" == typeof e ? this.each(function () {
										...
										var n, i;
										if (s && void 0 === t) {
											if (n = Me.get(s, e) || Me.get(s, e.replace(je, "-$&").toLowerCase()), void 0 !== n) return n;
							...
							re.event = {
								...
								add: function (e, t, n, i, o) {
									...
									if (g)
										for (n.handler && (s = n, n = s.handler, o = s.selector), n.guid || (n.guid = re.guid++), (l = g.events) || (l = g.events = {}), (r = g.handle) || (r = g.handle = function (t) {
								...
								remove: function (e, t, n, i, o) {
									...
									if (g && (l = g.events)) {
										for (t = (t || "").match(xe) || [""], u = t.length; u--;)
											if (a = We.exec(t[u]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
									...
									if (a[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
										for (r = re.event.handlers.call(this, e, l), t = 0;
											...
											for (e.currentTarget = o.elem, n = 0;
												 (s = o.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.rnamespace || e.rnamespace.test(s.namespace)) && (e.handleObj = s, e.data = s.data, i = ((re.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
							...
							re.extend({
								...
								clone: function (e, t, n) {
									...
									if (!(oe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || re.isXMLDoc(e)))
										for (r = c(a), s = c(e), i = 0, o = s.length; o > i; i++) x(s[i], r[i]);
									if (t)
										if (n)
								...
								cleanData: function (e) {
									for (var t, n, i, o = re.event.special, s = 0; void 0 !== (n = e[s]); s++)
										if (Ce(n)) {
											if (t = n[Te.expando]) {
												if (t.events)
							...
							re.extend({
								...
								style: function (e, t, n, i) {
									if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
										var o, s, r, a = re.camelCase(t),
												l = e.style;
										return t = re.cssProps[a] || (re.cssProps[a] = j(a) || a), r = re.cssHooks[t] || re.cssHooks[a], void 0 === n ? r && "get" in r && void 0 !== (o = r.get(e, !1, i)) ? o : l[t] : (s = typeof n, "string" === s && (o = Le.exec(n)) && o[1] && (n = d(e, t, o), s = "number"), null != n && n === n && ("number" === s && (n += o && o[3] || (re.cssNumber[a] ? "" : "px")), oe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), r && "set" in r && void 0 === (n = r.set(e, n, i)) || (l[t] = n)), void 0)
									}
								},
								css: function (e, t, n, i) {
									var o, s, r, a = re.camelCase(t);
									return t = re.cssProps[a] || (re.cssProps[a] = j(a) || a), r = re.cssHooks[t] || re.cssHooks[a], r && "get" in r && (o = r.get(e, !0, n)), void 0 === o && (o = M(e, t, i)), "normal" === o && t in nt && (o = nt[t]), "" === n || n ? (s = parseFloat(o), n === !0 || isFinite(s) ? s || 0 : o) : o
								}
								...
								re.cssHooks[t] = {
									...
									set: function (e, n, i) {
										var o, s = i && Qe(e),
												r = i && L(e, t, i, "border-box" === re.css(e, "boxSizing", !1, s), s);
										return r && (o = Le.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = re.css(e, t)), D(e, n, r)
									}
								}
							}), re.cssHooks.marginLeft = E(oe.reliableMarginLeft, function (e, t) {
								return t ? (parseFloat(M(e, "marginLeft")) || e.getBoundingClientRect().left - Je(e, {
									marginLeft: 0
								}, function () {
								...
								}, Ze.test(e) || (re.cssHooks[e + t].set = D)
							}), re.fn.extend({
								css: function (e, t) {
								...
								stop: function (e, t, n) {
									...
									return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
										...
										if (o) r[o] && r[o].stop && i(r[o]);
											...
											for (o in r) r[o] && r[o].stop && lt.test(o) && i(r[o]);
							...
							re.fn.extend({
								...
								removeAttr: function (e, t) {
									var n, i, o = 0,
											s = t && t.match(xe);
									if (s && 1 === e.nodeType)
										for (; n = s[o++];) i = re.propFix[n] || n, re.expr.match.bool.test(n) && (e[i] = !1), e.removeAttribute(n)
								}
							}), ut = {
								set: function (e, t, n) {
							...
							re.fn.extend({
								addClass: function (e) {
									...
									if ("string" == typeof e && e)
										for (t = e.match(xe) || []; n = this[l++];)
											if (o = W(n), i = 1 === n.nodeType && (" " + o + " ").replace(pt, " ")) {
								...
								toggleClass: function (e, t) {
									...
									return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : re.isFunction(e) ? this.each(function (n) {
										...
										var t, i, o, s;
										if ("string" === n)
											for (i = 0, o = re(this), s = e.match(xe) || []; t = s[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
										else(void 0 === e || "boolean" === n) && (t = W(this), t && Te.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Te.get(this, "__className__") || ""))
									})
								},
								hasClass: function (e) {
									var t, n, i = 0;
									...
									select: {
										get: function (e) {
											for (var t, n, i = e.options, o = e.selectedIndex, s = "select-one" === e.type || 0 > o, r = s ? null : [], a = s ? o + 1 : i.length, l = 0 > o ? a : s ? o : 0; a > l; l++)
												if (n = i[l], (n.selected || l === o) && (oe.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !re.nodeName(n.parentNode, "optgroup"))) {
							...
							re.extend(re.event, {
								trigger: function (t, n, i, o) {
									...
									if (r = a = i = i || X, 3 !== i.nodeType && 8 !== i.nodeType && !mt.test(p + re.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), u = p.indexOf(":") < 0 && "on" + p, t = t[re.expando] ? t : new re.Event(p, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), c = re.event.special[p] || {}, o || !c.trigger || c.trigger.apply(i, n) !== !1)) {
										...
										for (s = 0;
											 (r = h[s++]) && !t.isPropagationStopped();) t.type = s > 1 ? l : c.bindType || p, d = (Te.get(r, "events") || {})[t.type] && Te.get(r, "handle"), d && d.apply(r, n), d = u && r[u], d && d.apply && Ce(r) && (t.result = d.apply(r, n), t.result === !1 && t.preventDefault());
									...
									var o, s, r, a, l, u, d, c, h = re.ajaxSetup({}, n),
											...
											x = {
												...
												getResponseHeader: function (e) {
													...
													if (2 === b) {
														if (!a)
															for (a = {}; t = wt.exec(r);) a[t[1].toLowerCase()] = t[2];
														t = a[e.toLowerCase()]
													}
							...
							re.fn.load = function (e, t, n) {
								...
								setOffset: function (e, t, n) {
									var i, o, s, r, a, l, u, d = re.css(e, "position"),
											c = re(e),
											h = {};
							...
							return re.noConflict = function (t) {
								return e.$ === re && (e.$ = Ht), t && e.jQuery === re && (e.jQuery = Rt),
										re
							}, t || (e.jQuery = e.$ = re), re
			...
			14: [function (e, t, n) {
				...
				i.prototype.MARKER_CLUSTER_IMAGE_PATH_ = "https://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclusterer/images/m", i.prototype.MARKER_CLUSTER_IMAGE_EXTENSION_ = "png", i.prototype.extend = function (e, t) {
					...
					if (!e || !t) return 0;
					var n = 6371,
							i = (t.lat() - e.lat()) * Math.PI / 180,
							o = (t.lng() - e.lng()) * Math.PI / 180,
							s = Math.sin(i / 2) * Math.sin(i / 2) + Math.cos(e.lat() * Math.PI / 180) * Math.cos(t.lat() * Math.PI / 180) * Math.sin(o / 2) * Math.sin(o / 2),
							r = 2 * Math.atan2(Math.sqrt(s), Math.sqrt(1 - s)),
							a = n * r;
					return a
					...
					if (o < this.minClusterSize_ && e.getMap() != this.map_ && e.setMap(this.map_), o == this.minClusterSize_)
						for (var s = 0; o > s; s++) this.markers_[s].setMap(null);
					...
					if (t && e > t)
						for (var n, i = 0; n = this.markers_[i]; i++) n.setMap(this.map_);
					else {
			...
			15: [function (e, t, n) {
				(function (e) {
					(function (e, t, n, o, s) {
						...
						r.version = "2.18.2", r.meIndex = 0, r.plugins = {
							...
							getScriptPath: function (e) {
								for (var t, n, i, o, s, r, a = 0, l = "", u = "", d = document.getElementsByTagName("script"), c = d.length, h = e.length; c > a; a++) {
									for (o = d[a].src, n = o.lastIndexOf("/"), n > -1 ? (r = o.substring(n + 1), s = o.substring(0, n + 1)) : (r = o, s = ""), t = 0; h > t; t++)
							...
							calculateTimeFormat: function (e, t, n) {
								...
								i.length < r && (a = i[r]);
								for (var p = !1, f = 0, m = h.length; m > f; f++)
									if (-1 !== i.indexOf(h[f][1])) p = !0;
									else if (p) {
										for (var g = !1, v = f; m > v; v++)
											if (h[v][0] > 0) {
												g = !0;
												break
											}
							...
							init: function () {
								var e, t, n = this,
										i = document,
										o = r.PluginDetector.nav,
										s = r.PluginDetector.ua.toLowerCase(),
							...
							canPlayType: function (e) {
								...
								for (t = 0; t < o.length; t++)
									if (i = o[t], r.PluginDetector.hasPluginVersion(this.pluginType, i.version))
							...
							setSrc: function (e) {
								if ("string" == typeof e) this.pluginApi.setSrc(r.Utility.absolutizeUrl(e)), this.src = r.Utility.absolutizeUrl(e);
								else {
									var t, n;
							...
							create: function (e, t) {
								var n, i, o = {},
										...
										l = "audio" === a || "video" === a,
										u = l ? s.getAttribute("src") : s.getAttribute("href"),
							...
							determinePlayback: function (e, t, n, i, o) {
								...
								if ("undefined" != typeof t.type && "" !== t.type)
									if ("string" == typeof t.type) v.push({
										...
										for (s = 0; s < t.type.length; s++) v.push({
											type: t.type[s],
											url: o
										});
									...
									for (s = 0; s < e.childNodes.length; s++) d = e.childNodes[s], 1 == d.nodeType && "source" == d.tagName.toLowerCase() && (o = d.getAttribute("src"), c = this.formatType(o, d.getAttribute("type")), g = d.getAttribute("media"), (!g || !window.matchMedia || window.matchMedia && window.matchMedia(g).matches) && v.push({
										type: c,
										url: o
									}));
								if (!i && v.length > 0 && null !== v[0].url && this.getTypeFromFile(v[0].url).indexOf("audio") > -1 && (y.isVideo = !1), r.MediaFeatures.isBustedAndroid && (e.canPlayType = function (e) {
									...
									for (i || (m = document.createElement(y.isVideo ? "video" : "audio"), e.parentNode.insertBefore(m, e), e.style.display = "none", y.htmlMediaElement = e = m), s = 0; s < v.length; s++)
										if ("video/m3u8" == v[s].type || "" !== e.canPlayType(v[s].type).replace(/no/, "") || "" !== e.canPlayType(v[s].type.replace(/mp3/, "mpeg")).replace(/no/, "") || "" !== e.canPlayType(v[s].type.replace(/m4a/, "mp4")).replace(/no/, "")) {
								...
								if ("auto" === t.mode || "auto_plugin" === t.mode || "shim" === t.mode)
									for (s = 0; s < v.length; s++)
										for (c = v[s].type, a = 0; a < t.plugins.length; a++)
											for (h = t.plugins[a], p = r.plugins[h], l = 0; l < p.length; l++)
												if (f = p[l], null == f.version || r.PluginDetector.hasPluginVersion(h, f.version))
													for (u = 0; u < f.types.length; u++)
														if (c.toLowerCase() == f.types[u].toLowerCase()) return y.method = h, y.url = v[s].url, y;
							...
							createPlugin: function (e, t, n, i, o, s) {
								var a, l, u, d = e.htmlMediaElement,
										c = 1,
										h = 1,
										p = "me_" + e.method + "_" + r.meIndex++,
										f = new r.PluginMediaElement(p, e.method, e.url),
						...
						}, window.mejs = r, window.MediaElement = r.MediaElement,
								function (e, t, n) {
									"use strict";
									var i = {
										locale: {
							...
							return e && (t += parseInt($(this).css("margin-right"), 10), t += parseInt($(this).css("margin-left"), 10)), t
						}) : "undefined" != typeof ender && (r.$ = ender),
								function (e) {
									r.MepDefaults = {
										poster: "",
										...
										meReady: function (t, n) {
											...
											if (!s.created) {
												if (s.created = !0, s.media = t, s.domNode = n, !(a.isAndroid && s.options.AndroidUseNativeControls || a.isiPad && s.options.iPadUseNativeControls || a.isiPhone && s.options.iPhoneUseNativeControls)) {
													...
													for (i in s.options.features)
														if (o = s.options.features[i], s["build" + o]) try {
										...
										setPlayerSize: function (t, n) {
											...
											if ("undefined" != typeof t && (i.width = t), "undefined" != typeof n && (i.height = n), i.height.toString().indexOf("%") > 0 || "none" !== i.$node.css("max-width") && "t.width" !== i.$node.css("max-width") || i.$node[0].currentStyle && "100%" === i.$node[0].currentStyle.maxWidth) {
												var o = function () {
														...
														l = i.isVideo || !i.options.autosizeProgress ? parseInt(r * s / o, 10) : s;
										...
										setPoster: function (t) {
											var n = this,
													...
													o = i.find("img");
											0 === o.length && (o = e('<img width="100%" height="100%" alt="" />').appendTo(i)), o.attr("src", t), i.css({
										...
										buildoverlays: function (t, n, i, o) {
											...
											if (t.isVideo) {
												var a = e('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-loading"><span></span></div></div>').hide().appendTo(i),
														l = e('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-error"></div></div>').hide().appendTo(i),
										...
										onkeydown: function (e, t, n) {
											if (e.hasFocus && e.options.enableKeyboard)
												for (var i = 0, o = e.options.keyActions.length; o > i; i++)
													for (var s = e.options.keyActions[i], r = 0, a = s.keys.length; a > r; r++)
														if (n.keyCode == s.keys[r]) return "function" == typeof n.preventDefault && n.preventDefault(), s.action(e, t, n.keyCode), !1;
											return !0
										},
										findTracks: function () {
											var t = this,
										...
										resetSize: function () {
											...
											function () {
												...
												r.MediaElementPlayer.prototype.globalBind = function (n, i, o) {
													var s = this,
															r = s.node ? s.node.ownerDocument : document;
								...
								function (e) {
									e.extend(r.MepDefaults, {
										...
										buildplaypause: function (t, n, i, o) {
											...
											var r = this,
													a = r.options,
													l = e('<div class="mejs-button mejs-playpause-button mejs-play" ><button type="button" aria-controls="' + r.id + '" title="' + a.playText + '" aria-label="' + a.playText + '"></button></div>').appendTo(n).click(function (e) {
								...
								function (e) {
									e.extend(r.MepDefaults, {
										progessHelpText: r.i18n.t("Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.")
									}), e.extend(MediaElementPlayer.prototype, {
										buildprogress: function (t, n, i, o) {
											...
											var s = this,
													...
													l = n.find(".mejs-time-loaded"),
													u = n.find(".mejs-time-current"),
													d = n.find(".mejs-time-handle"),
													c = n.find(".mejs-time-float"),
													h = n.find(".mejs-time-float-current"),
													...
													v = 0,
													y = !1,
													_ = t.options.autoRewind,
													b = function (e) {
														var n = o.currentTime,
																i = r.i18n.t("Time Slider"),
																s = r.Utility.secondsToTimeCode(n, t.options),
																a = o.duration;
														p.attr({
															"aria-label": i,
															"aria-valuemin": 0,
									...
									e.extend(r.MepDefaults, {
										...
										buildfullscreen: function (t, n, i, o) {
											if (t.isVideo) {
												...
												var a = this,
														l = e('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' + a.id + '" title="' + a.options.fullscreenText + '" aria-label="' + a.options.fullscreenText + '"></button></div>').appendTo(n);
													...
													if (d && !r.MediaFeatures.isOpera) {
														var c, h, p = !1,
																...
																v = function () {
																	...
																	m.top.width(o).height(t), m.left.width(e).height(i).css({
																		top: t
																	}), m.right.width(o - e - n).height(i).css({
																		top: t,
																		left: e + n
																	}), m.bottom.width(o).height(s - i - t).css({
																		top: t + i
																	})
																};
										...
										enterFullScreen: function () {
											...
											if ("native" === t.media.pluginType || !r.MediaFeatures.isFirefox && !t.options.usePluginFullScreen) {
												if (e(document.documentElement).addClass("mejs-fullscreen"), t.normalHeight = t.container.height(), t.normalWidth = t.container.width(), "native" === t.media.pluginType)
													if (r.MediaFeatures.hasTrueNativeFullScreen) r.MediaFeatures.requestFullScreen(t.container[0]), t.isInIframe && setTimeout(function i() {
													...
													else if (r.MediaFeatures.hasSemiNativeFullScreen) return void t.media.webkitEnterFullscreen();
												if (t.isInIframe) {
									...
									e.extend(r.MepDefaults, {
										...
										buildspeed: function (t, n, i, o) {
											...
											if ("native" == s.media.pluginType) {
												...
												var m = function (e) {
															for (h = 0, p = d.length; p > h; h++)
																if (d[h].value === e) return d[h].name
														},
											...
											parse: function (t) {
												for (var n, i, o, s = 0, a = r.TrackFormatParser.split2(t, /\r?\n/), l = {
													...
													if (n = this.pattern_timecode.exec(a[s]), n && s < a.length) {
														for (s - 1 >= 0 && "" !== a[s - 1] && (o = a[s - 1]), s++, i = a[s], s++;
															 "" !== a[s] && s < a.length;) i = i + "\n" + a[s], s++;
										...
										dfxp: {
											parse: function (t) {
												...
												if (l.length) {
													...
													if (d.length)
														for (n = {}, o = 0; o < d.length; o++) n[d[o].name.split(":")[1]] = d[o].value
												}
								...
								function (e) {
									e.extend(r.MepDefaults, {
										...
										renderContextMenu: function (t, n) {
											for (var i = this, o = "", s = i.options.contextMenuItems, r = 0, a = s.length; a > r; r++)
								...
								function (e) {
									e.extend(r.MepDefaults, {
										...
										buildskipback: function (t, n, i, o) {
											var s = this,
													r = s.options.skipBackText.replace("%1", s.options.skipBackInterval);
								...
								function (e) {
									e.extend(r.MepDefaults, {
										postrollCloseText: r.i18n.t("Close")
									}), e.extend(MediaElementPlayer.prototype, {
			...
			16: [function (e, t, n) {
				!function (e, i) {
					...
					function m(e, t) {
						var n, i, o;
						if (f(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), f(t._i) || (e._i = t._i), f(t._f) || (e._f = t._f), f(t._l) || (e._l = t._l), f(t._strict) || (e._strict = t._strict), f(t._tzm) || (e._tzm = t._tzm), f(t._isUTC) || (e._isUTC = t._isUTC), f(t._offset) || (e._offset = t._offset), f(t._pf) || (e._pf = c(t)), f(t._locale) || (e._locale = t._locale), Qn.length > 0)
							for (n in Qn) i = Qn[n], o = t[i], f(o) || (e[i] = o);
						return e
					}
					...
					function I(e, t) {
						...
						else if (e = j(e), L(this[e])) return this[e](t);
						return this
					}
					...
					function B(e) {
						return U(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (e, t, n, i, o) {
							return t || n || i || o
						}))
					}
					...
					function oe() {
						...
						for (i.sort(e), o.sort(e), s.sort(e), t = 0; 12 > t; t++) i[t] = U(i[t]), o[t] = U(o[t]), s[t] = U(s[t]);
					...
					function se(e) {
						var t, n = e._a;
						return n && -2 === c(e).overflow && (t = n[Ci] < 0 || n[Ci] > 11 ? Ci : n[Ti] < 1 || n[Ti] > Z(n[Si], n[Ci]) ? Ti : n[Mi] < 0 || n[Mi] > 24 || 24 === n[Mi] && (0 !== n[Ei] || 0 !== n[ji] || 0 !== n[Di]) ? Mi : n[Ei] < 0 || n[Ei] > 59 ? Ei : n[ji] < 0 || n[ji] > 59 ? ji : n[Di] < 0 || n[Di] > 999 ? Di : -1, c(e)._overflowDayOfYear && (Si > t || t > Ti) && (t = Ti), c(e)._overflowWeeks && -1 === t && (t = Li), c(e)._overflowWeekday && -1 === t && (t = Pi), c(e).overflow = t), e
					}
					...
					function ue(e) {
						var t, n, i, o, s, r, a = e._i,
								l = Ri.exec(a) || Hi.exec(a);
						if (l) {
							for (c(e).iso = !0, t = 0, n = qi.length; n > t; t++)
								if (qi[t][1].exec(l[1])) {
									o = qi[t][0], i = qi[t][2] !== !1;
									break
								}
					...
					function xe(e) {
						...
						if (!e._d) {
							...
							24 === e._a[Mi] && 0 === e._a[Ei] && 0 === e._a[ji] && 0 === e._a[Di] && (e._nextDay = !0, e._a[Mi] = 0), e._d = (e._useUTC ? he : ce).apply(null, s), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[Mi] = 24)
						}
					}
					...
					function je(e) {
						var t = e._i,
								n = e._f;
						return e._locale = e._locale || M(e._l), null === t || void 0 === n && "" === t ? p({
							nullInput: !0
						}) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), v(t) ? new g(se(t)) : (o(n) ? Te(e) : n ? Se(e) : s(t) ? e._d = t : De(e), h(e) || (e._d = null), e))
					}
					...
					function at(e, t) {
						var n = v(e) ? e : Pe(e);
						return this.isValid() && n.isValid() ? (t = j(f(t) ? "millisecond" : t), "millisecond" === t ? +this > +n : +n < +this.clone().startOf(t)) : !1
					}

					function lt(e, t) {
						var n = v(e) ? e : Pe(e);
						return this.isValid() && n.isValid() ? (t = j(f(t) ? "millisecond" : t), "millisecond" === t ? +n > +this : +this.clone().endOf(t) < +n) : !1
					}
					...
					function dt(e, t) {
						var n, i = v(e) ? e : Pe(e);
						return this.isValid() && i.isValid() ? (t = j(t || "millisecond"), "millisecond" === t ? +this === +i : (n = +i, +this.clone().startOf(t) <= n && n <= +this.clone().endOf(t))) : !1
					}
					...
					function pt(e, t, n) {
						var i, o, s, r;
						return this.isValid() ? (i = He(e, this), i.isValid() ? (o = 6e4 * (i.utcOffset() - this.utcOffset()), t = j(t), "year" === t || "month" === t || "quarter" === t ? (r = ft(this, i), "quarter" === t ? r /= 3 : "year" === t && (r /= 12)) : (s = this - i, r = "second" === t ? s / 1e3 : "minute" === t ? s / 6e4 : "hour" === t ? s / 36e5 : "day" === t ? (s - o) / 864e5 : "week" === t ? (s - o) / 6048e5 : s), n ? r : y(r)) : NaN) : NaN
					}
					...
					function Ct(e) {
						return e = j(e), void 0 === e || "millisecond" === e ? this : this.startOf(e).add(1, "isoWeek" === e ? "week" : e).subtract(1, "ms")
					}
					...
					function On(e) {
						...
						if (e = j(e), "month" === e || "year" === e) return t = this._days + i / 864e5, n = this._months + Fn(t), "month" === e ? n : n / 12;
					...
					function Un(e, t, n) {
						var i = Ke(e).abs(),
								...
								l = Oo(i.as("M")),
								u = Oo(i.as("y")),
								d = o < Ro.s && ["s", o] || 1 >= s && ["m"] || s < Ro.m && ["mm", s] || 1 >= r && ["h"] || r < Ro.h && ["hh", r] || 1 >= a && ["d"] || a < Ro.d && ["dd", a] || 1 >= l && ["M"] || l < Ro.M && ["MM", l] || 1 >= u && ["y"] || ["yy", u];
					...
					var Zn, Xn, Qn = n.momentProperties = [],
							Jn = !1,
							Kn = {},
							ei = {},
					...
					var Ai = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
							Ni = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
							Ii = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),
							Fi = wi,
							zi = wi,
							Oi = {};
					...
					}), z(0, ["YYYY", 4], 0, "year"), z(0, ["YYYYY", 5], 0, "year"), z(0, ["YYYYYY", 6, !0], 0, "year"), E("year", "y"), q("Y", vi), q("YY", di, ri), q("YYYY", fi, li), q("YYYYY", mi, ui), q("YYYYYY", mi, ui), V(["YYYYY", "YYYYYY"], Si), V("YYYY", function (e, t) {
					...
					var Vi = ae("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548", function () {
					...
					Oe("Z", ":"), Oe("ZZ", ""), q("Z", _i), q("ZZ", _i), V(["Z", "ZZ"], function (e, t, n) {
						n._useUTC = !0, n._tzm = Re(_i, e)
					});
					var Zi = /([\+\-]|\d\d)/gi;
					n.updateOffset = function () {
					};
					var Xi = /^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/,
					...
					}), z("Q", 0, "Qo", "quarter"), E("quarter", "Q"), q("Q", si), V("Q", function (e, t) {
						t[Ci] = 3 * (_(e) - 1)
					...
					z("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), E("dayOfYear", "DDD"), q("DDD", pi), q("DDDD", ai), V(["DDD", "DDDD"], function (e, t, n) {
						n._dayOfYear = _(e)
					...
					}), rn("a", !0), rn("A", !1), E("hour", "h"), q("a", an), q("A", an), q("H", di), q("h", di), q("HH", di, ri), q("hh", di, ri), q("hmm", ci), q("hmmss", hi), q("Hmm", ci), q("Hmmss", hi), V(["H", "HH"], Mi), V(["a", "A"], function (e, t, n) {
						...
						var i = e.length - 4,
								o = e.length - 2;
						t[Mi] = _(e.substr(0, i)), t[Ei] = _(e.substr(i, 2)), t[ji] = _(e.substr(o)), c(n).bigHour = !0
					}), V("Hmm", function (e, t, n) {
						var i = e.length - 2;
						...
						var i = e.length - 4,
								o = e.length - 2;
						t[Mi] = _(e.substr(0, i)), t[Ei] = _(e.substr(i, 2)), t[ji] = _(e.substr(o))
					});
					var ro = /[ap]\.?m?\.?/i,
							ao = P("Hours", !0);
					z("m", ["mm", 2], 0, "minute"), E("minute", "m"), q("m", di), q("mm", di, ri), V(["m", "mm"], Ei);
					var lo = P("Minutes", !1);
					z("s", ["ss", 2], 0, "second"), E("second", "s"), q("s", di), q("ss", di, ri), V(["s", "ss"], ji);
					var uo = P("Seconds", !1);
					z("S", 0, 0, function () {
					...
					for (co = "S"; co.length <= 9; co += "S") V(co, dn);
					var ho = P("Milliseconds", !1);
					z("z", 0, 0, "zoneAbbr"), z("zz", 0, 0, "zoneName");
					var po = g.prototype;
					po.add = Ji, po.calendar = st, po.clone = rt, po.diff = pt, po.endOf = Ct, po.format = vt, po.from = yt, po.fromNow = _t, po.to = bt, po.toNow = wt, po.get = I, po.invalidAt = Nt, po.isAfter = at, po.isBefore = lt, po.isBetween = ut, po.isSame = dt, po.isSameOrAfter = ct, po.isSameOrBefore = ht, po.isValid = Pt, po.lang = eo, po.locale = xt, po.localeData = kt, po.max = $i, po.min = Vi, po.parsingFlags = At, po.set = I, po.startOf = St, po.subtract = Ki, po.toArray = jt, po.toObject = Dt, po.toDate = Et, po.toISOString = gt, po.toJSON = Lt, po.toString = mt, po.unix = Mt, po.valueOf = Tt, po.creationData = It, po.year = Ui, po.isLeapYear = me, po.weekYear = zt, po.isoWeekYear = Ot, po.quarter = po.quarters = Yt, po.month = ee, po.daysInMonth = te, po.week = po.weeks = $t, po.isoWeek = po.isoWeeks = Gt, po.weeksInYear = Ht, po.isoWeeksInYear = Rt, po.date = no, po.day = po.days = en, po.weekday = tn, po.isoWeekday = nn, po.dayOfYear = on, po.hour = po.hours = ao, po.minute = po.minutes = lo, po.second = po.seconds = uo, po.millisecond = po.milliseconds = ho, po.utcOffset = qe, po.utc = Be, po.local = Ue, po.parseZone = Ve, po.hasAlignedHourOffset = $e, po.isDST = Ge, po.isDSTShifted = Ze, po.isLocal = Xe, po.isUtcOffset = Qe, po.isUtc = Je, po.isUTC = Je, po.zoneAbbr = cn, po.zoneName = hn, po.dates = ae("dates accessor is deprecated. Use date instead.", no), po.months = ae("months accessor is deprecated. Use month instead", ee), po.years = ae("years accessor is deprecated. Use year instead", Ui), po.zone = ae("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779", Ye);
					var fo = po,
							mo = {
								sameDay: "[Today at] LT",
					...
					var xo = Math.abs,
							...
							Ho = Math.abs,
							Wo = Fe.prototype;
					Wo.abs = Dn, Wo.add = Pn, Wo.subtract = An, Wo.as = On, Wo.asMilliseconds = ko, Wo.asSeconds = So, Wo.asMinutes = Co, Wo.asHours = To, Wo.asDays = Mo, Wo.asWeeks = Eo, Wo.asMonths = jo, Wo.asYears = Do, Wo.valueOf = Rn, Wo._bubble = In, Wo.get = Wn, Wo.milliseconds = Lo, Wo.seconds = Po, Wo.minutes = Ao, Wo.hours = No, Wo.days = Io, Wo.weeks = Yn, Wo.months = Fo, Wo.years = zo, Wo.humanize = $n, Wo.toISOString = Gn, Wo.toString = Gn, Wo.toJSON = Gn, Wo.locale = xt, Wo.localeData = kt, Wo.toIsoString = ae("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Gn), Wo.lang = eo, z("X", 0, 0, "unix"), z("x", 0, 0, "valueOf"), q("x", vi), q("X", bi), V("X", function (e, t, n) {
						n._d = new Date(1e3 * parseFloat(e, 10))
					}), V("x", function (e, t, n) {
						n._d = new Date(_(e))
					}), n.version = "2.11.2", i(Pe), n.fn = fo, n.min = Ne, n.max = Ie, n.now = Gi, n.utc = u, n.unix = pn, n.months = Cn, n.isDate = s, n.locale = C, n.invalid = p, n.duration = Ke, n.isMoment = v, n.weekdays = Mn, n.parseZone = fn, n.localeData = M, n.isDuration = ze, n.monthsShort = Tn, n.weekdaysMin = jn, n.defineLocale = T, n.weekdaysShort = En, n.normalizeUnits = j, n.relativeTimeThreshold = Vn, n.prototype = fo;
					var qo = n;
					return qo
				})
			}, {}],
						...
						!function (n) {
							...
							function h() {
								var e = void 0 !== window.pageXOffset,
										...
										i = e ? window.pageYOffset : t ? document.documentElement.scrollTop : document.body.scrollTop;
								return {
									x: n,
									y: i
								}
							...
							function W(t, i) {
								...
								function w() {
									...
									var e = X.map(b);
									i.dir && (e.reverse(), i.tooltips.reverse()), V("update", function (t, n, o) {
								...
								function k(t, n, i) {
									...
									return ee.direction = 0, i = e(i.slice().sort(function (e, t) {
										...
										var a, l, h, p, f, m, g, v, y, _, b = e,
												w = i[s + 1];
										if ("steps" === n && (a = ee.xNumSteps[s]), a || (a = w - b), b !== !1 && void 0 !== w)
											for (l = b; w >= l; l = o(l, a)) {
								...
								function S(e, t, n) {
									...
									var a = ["horizontal", "vertical"][i.ort],
								...
								function D(e, t) {
									...
									var n, i, s = t.handles || X,
											r = !1,
											a = 100 * (e.calcPoint - t.start) / t.baseSize,
											l = s[0] === X[0] ? 0 : 1;
									if (n = o(a, t.positions, s.length > 1), r = z(s[0], n[l], 1 === s.length), s.length > 1) {
										if (r = z(s[1], n[l ? 0 : 1], !1) || r)
											for (i = 0; i < t.handles.length; i++) M("slide", i)
									} else r && M("slide", l)
								}

								function L(e, t) {
									var n = Z.querySelector("." + ie[15]),
											i = t.handles[0] === X[0] ? 0 : 1;
								...
								function N(e) {
									...
									return e.stopPropagation(), X.forEach(function (e) {
										a += n(e)[i.style]
									}), t = a / 2 > r || 1 === X.length ? 0 : 1, r -= n(Z)[i.style], o = 100 * r / T(), i.events.snap || s(J, ie[14], 300), X[t].hasAttribute("disabled") ? !1 : (z(X[t], o), M("slide", t, !0), M("set", t, !0), M("change", t, !0), void(i.events.snap && A(e, {
										handles: [X[t]]
									})))
								}

								function I(e) {
									var t = e.calcPoint - n(Z)[i.style],
											o = ee.getStep(100 * t / T()),
											s = ee.fromStepping(o);
								...
								function F(e) {
									var t, n;
									if (!e.fixed)
										for (t = 0; t < X.length; t += 1) j(Y.start, X[t].children[0], A, {
											handles: [X[t]],
											handleNumber: t
										});
									if (e.tap && j(Y.start, Z, N, {
												handles: X
											}), e.hover)
										for (j(Y.move, Z, I, {
											hover: !0
										}), t = 0; t < X.length; t += 1)["mousemove MSPointerMove pointermove"].forEach(function (e) {
								...
								function U() {
									var e = K.map(function (e, t) {
										var n = ee.getApplicableStep(e),
												i = l(String(n[2])),
												o = te[t],
												s = 100 === e ? null : n[2],
												r = Number((o - n[2]).toFixed(i)),
												a = 0 === e ? null : r >= n[1] ? n[2] : n[0] || !1;
										return [a, s]
									});
									return E(e)
								}
								...
								var Z, X, Q, J = t,
										...
										te = [],
										ne = {},
										ie = ["target", "base", "origin", "handle", "horizontal", "vertical", "background", "connect", "ltr", "rtl", "draggable", "", "state-drag", "", "state-tap", "active", "", "stacking", "tooltip", "", "pips", "marker", "value"].map(f(i.cssPrefix || B));
					...
					var t = "function" == typeof e,
							...
							S = function (e, t, n) {
								var i = new Date(n, 0, 1),
										o = Math.ceil(((new Date(n, t, e) - i) / 864e5 + i.getDay() + 1) / 7);
							...
							D = function (r) {
								...
								a._onMouseDown = function (e) {
									if (a._v) {
										...
										if (t)
											if (u(t, "is-disabled") || (u(t, "pika-button") && !u(t, "is-empty") ? (a.setDate(new Date(t.getAttribute("data-pika-year"), t.getAttribute("data-pika-month"), t.getAttribute("data-pika-day"))), l.bound && o(function () {
														a.hide(), l.field && l.field.blur()
													}, 100)) : u(t, "pika-prev") ? a.prevMonth() : u(t, "pika-next") && a.nextMonth()), u(t, "pika-select")) a._c = !0;
											else {
									...
									if (t) {
										...
										do
											if (u(i, "pika-single") || i === l.trigger) return;
					...
					return D.prototype = {
						...
						setDate: function (e, t) {
							...
							if ("string" == typeof e && (e = new Date(Date.parse(e))), p(e)) {
								var n = this._o.minDate,
										i = this._o.maxDate;
								p(n) && n > e ? e = n : p(i) && e > i && (e = i), this._d = new Date(e.getTime()), v(this._d), this.gotoDate(this._d), this._o.field && (this._o.field.value = this.toString(), a(this._o.field, "change", {
									firedBy: this
						...
						adjustPosition: function () {
							...
							if (!this._o.container) {
								if (this.el.style.position = "absolute", e = this._o.trigger, t = e, n = this.el.offsetWidth, o = this.el.offsetHeight, s = window.innerWidth || i.documentElement.clientWidth, r = window.innerHeight || i.documentElement.clientHeight, a = window.pageYOffset || i.body.scrollTop || i.documentElement.scrollTop, "function" == typeof e.getBoundingClientRect) d = e.getBoundingClientRect(), l = d.left + window.pageXOffset, u = d.bottom + window.pageYOffset;
									...
									for (l = t.offsetLeft, u = t.offsetTop + t.offsetHeight; t = t.offsetParent;) l += t.offsetLeft, u += t.offsetTop;
						...
						render: function (e, t) {
							...
							for (var d = 0, c = 0; l > d; d++) {
								var h = new Date(e, t, 1 + (d - s)),
										m = p(this._d) ? y(h, this._d) : !1,
										_ = y(h, i),
										b = s > d || d >= o + s,
										w = n.startRange && y(n.startRange, h),
										x = n.endRange && y(n.endRange, h),
										T = n.startRange && n.endRange && n.startRange < h && h < n.endRange,
										M = n.minDate && h < n.minDate || n.maxDate && h > n.maxDate || n.disableWeekends && f(h) || n.disableDayFn && n.disableDayFn(h),
										E = {
											day: 1 + (d - s),
											month: t,
											year: e,
				...
				!function (t, i) {
					...
					e.fn.pikaday = function () {
						...
						return n && n.length || (n = [{}]), this.each(function () {
							var i = e(this),
									o = i.data("pikaday");
							if (o instanceof t) "string" == typeof n[0] && "function" == typeof o[n[0]] && (o[n[0]].apply(o, Array.prototype.slice.call(n, 1)), "destroy" === n[0] && i.removeData("pikaday"));
							else if ("object" == typeof n[0]) {
								var s = e.extend({}, n[0]);
    ...
    var firstModuleLink = $('.js-module-link')[0];
    if (firstModuleLink) { firstModuleLink.click(); }
};

Edools.events.subscribe('school.dashboard', init);
Edools.events.subscribe('school.auth', init);